...
Route::post('registration/save', array(
    'as' => 'registration-save',
    'uses' => 'HomeController@saveRegistration',
    'before' => 'csrf'
));

Route::get('send-mail/login', 'SendmailController@handleMailLogin');
Route::post('send-mail/authenticate', array(
    'as' => 'sendmail-authenticate',
    'uses' => 'SendmailController@authenticateUserDetails',
    'before' => 'csrf'
));

Route::get('o-auth/login', 'UserController@handleLoginPage');
...
{
    Route::get('o-auth/dashboard/{id}', 'UserController@handleDashboardPage');
});
